public class Pessoa {
    ...
    public Pessoa(String nome, String telefone, String cpf) throws Dadoinvalido {
    validar(nome, telefone, cpf);
    this.nome = nome;
    this.telefone = telefone;
    this.cpf = cpf;
}
    private void validar(String nome, String telefone, String cpf) throws Dadoinvalido {
        if (nome == null || nome.isBlank()) {
            throw new Dadoinvalido("Nome não pode ser vazio");
        }
        if (telefone == null || telefone.isBlank()) {
            throw new Dadoinvalido("Telefone não pode ser vazio");
        }
        if (cpf == null || !cpf.matches("\\d{11}")) {
            throw new Dadoinvalido("CPF deve ter 11 dígitos numéricos");
        }
    }
    ...
    public String comprimentar(Aluno aluno) {
    ...
    public String comprimentar(Funcionarios funcionario) {
