...
public class Main2 {
    ...
    private static Pessoa criarPessoa(Interfaceusuario ui, String nome, String telefone, String cpf, String cargo) throws Dadoinvalido {
        switch (cargo.toLowerCase()) {
            case "a" -> {
                ...
                Aluno aluno = new Aluno(mtr1, nome, telefone, cpf, curso);
            ...
            case "f" -> {
                ...
                Funcionarios funcionario = new Funcionarios(nome, telefone, cpf, cod, funcao);
            ...
            case "r" -> {
                ...
                for (int i = 0; i < numAlunos; i++) {
                    ...
                    Aluno aluno = new Aluno(mtr1, nomeAluno, telAluno, cpfAluno, curso);
